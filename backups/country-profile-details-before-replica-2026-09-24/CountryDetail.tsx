...
function DatavizCode({ code, iso3 }: { code: string; iso3: string | null }) {
  ...
  useEffect(() => {
    ...
    try {
      ...
      Promise.resolve(fn.call(host)).catch((err: unknown) => {
      ...
      <div className="website-layout">
        <div id="left-panel" className="sidebar-menu">
          <div className="country-title-print">
            <div className="title text-blue font-bold">{country.name}</div>
          </div>
          {pdfUrl && (
        ...
        <div id="main-panel" className="relative website-content-area">
          <div className="country-profile-content">
            ...
            <div id="summary" className="tab-content">
              {pdfUrl && (
                <div id="mobile-cp-download" className="print-country-profile desktop" style={{ marginLeft: 5 }}>
