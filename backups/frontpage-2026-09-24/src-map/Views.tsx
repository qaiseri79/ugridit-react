...
import FiltersHeaders, { Filters, type KeywordConfig } from './Filters'
...
export default function Views({ mxManager, enableDownloads }: { mxManager: MxSdkManager; enableDownloads?: boolean }) {
  ...
  return (
    <div>
      <div>
        ...
        <div className="flex">
          ...
          <div className="flex flex-col w-full">
            ...
            {(!listUsp.value || listUsp.value == 'explore') && listUsp.value != 'pinned' && (
              <div className="sticky border-r border-gray1 top-11">
                <div className="">
                  <div className="flex space-x-2">
                    {/* Free text search */}
                    <div className="interact-with-layer grow">
                      <Input
                  ...
                  <div className="flex flex-col bg-white space-x-2">
                    {/* Keywords button */}
                    <div className="interact-with-layer-2 grow">
                      <Checkbox
                        label="Show only the active layers"
                        className="font-semibold h-full text-sm py-2 px-4 border-t"
                        onClick={() => setToggledOnly(!toggledOnly)}
                      ></Checkbox>
                      <div className="flex justify-start border-b pb-1">
                        <Symbol value="wrong_location" className="pl-3 font-semibold align-middle" />
                        <button className="pl-3 font-semibold mr-4 text-sm" onClick={clearCurrentViews}>
            ...
            {/** Explore list */}
            <div className={classNames('explore-list px-5 w-full', { hidden: listUsp.value === 'pinned' })}>
      ...
      {/** Pinned list */}
      <div className={classNames({ hidden: listUsp.value !== 'pinned' })}>
        {listUsp.value === 'pinned' && !pinCountUsp.value && (
          <div className="m-5 text-center">
            None; select some from sections <em>Featured</em> or <em>Explore</em>...
          </div>
        )}
        {listUsp.value === 'pinned' && pinCountUsp.value > 0 && (
          <div className="workspace-button flex justify-between border-b pb-5 pt-5 pl-2 pr-2">
